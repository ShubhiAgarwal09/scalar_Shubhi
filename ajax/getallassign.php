...
session_start();
        $query=$db->prepare('SELECT mentorlist.email as memail,studentlist.email as smail FROM mentorlist JOIN assign ON assign.id = mentorlist.id JOIN studentlist  ON studentlist.sid=assign.sid');
        $data=array();
